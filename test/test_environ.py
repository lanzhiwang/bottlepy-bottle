...
class TestRequest(unittest.TestCase):
    ...
    def test_url(self):
        ...
        request = BaseRequest(
            {"HTTP_HOST": "example.com", "PATH_INFO": "/pa th", "SCRIPT_NAME": "/s p"}
        )
...
class TestResponse(unittest.TestCase):
    ...
    def test_set_cookie(self):
        ...
        cookies = [
            value for name, value in r.headerlist if name.title() == "Set-Cookie"
        ]
        cookies.sort()
    ...
    def test_set_cookie_name_long_string(self):
        r = BaseResponse()
        self.assertRaises(
            ValueError, r.set_cookie, name="x" * 4097, value="simple_value"
        )
    ...
    def test_set_cookie_expires(self):
        ...
        self.assertEqual(
            cookies[0], "name1=value; expires=Thu, 01 Jan 1970 00:00:42 GMT"
        )
        self.assertEqual(
    ...
    def test_clone_cookie(self):
        ...
        cookies = sorted(
            [value for name, value in r2.headerlist if name.title() == "Set-Cookie"]
        )
    ...
    def test_delete_cookie(self):
        ...
        cookies = [
            value for name, value in response.headerlist if name.title() == "Set-Cookie"
        ]
    ...
    def test_set_header(self):
        ...
        response["x-test"] = "foo"
        headers = [
            value for name, value in response.headerlist if name.title() == "X-Test"
        ]
...
class TestRedirect(unittest.TestCase):
    ...
    def test_absolute_path(self):
        ...
        self.assertRedirect(
            "/test.html", "http://127.0.0.1/test.html", PATH_INFO="/some/sub/file.html"
        )
        self.assertRedirect(
    ...
    def test_relative_path(self):
        ...
        self.assertRedirect("./test.html", "http://127.0.0.1/test.html")
        self.assertRedirect(
            "./test.html", "http://127.0.0.1/foo/test.html", PATH_INFO="/foo/"
        )
        self.assertRedirect(
            "./test.html", "http://127.0.0.1/foo/test.html", PATH_INFO="/foo/bar.html"
        )
        self.assertRedirect(
            "./test.html", "http://127.0.0.1/foo/test.html", SCRIPT_NAME="/foo/"
        )
        self.assertRedirect(
            "./test.html",
            "http://127.0.0.1/foo/bar/test.html",
            SCRIPT_NAME="/foo/",
            PATH_INFO="/bar/baz.html",
        )
        self.assertRedirect("./foo/test.html", "http://127.0.0.1/foo/test.html")
        self.assertRedirect(
            "./foo/test.html",
            "http://127.0.0.1/bar/foo/test.html",
            PATH_INFO="/bar/file.html",
        )
        self.assertRedirect(
            "../test.html", "http://127.0.0.1/test.html", PATH_INFO="/foo/"
        )
        self.assertRedirect(
            "../test.html", "http://127.0.0.1/foo/test.html", PATH_INFO="/foo/bar/"
        )
        self.assertRedirect(
            "../test.html", "http://127.0.0.1/test.html", PATH_INFO="/foo/bar.html"
        )
        self.assertRedirect(
            "../test.html", "http://127.0.0.1/test.html", SCRIPT_NAME="/foo/"
        )
        self.assertRedirect(
            "../test.html",
            "http://127.0.0.1/foo/test.html",
    ...
    def test_sheme(self):
        self.assertRedirect(
            "./test.html", "https://127.0.0.1/test.html", wsgi_url_scheme="https"
        )
        self.assertRedirect(
            "./test.html",
            "https://127.0.0.1:80/test.html",
    ...
    def test_host_http_1_1(self):
        self.assertRedirect(
            "./test.html", "http://example.com/test.html", HTTP_HOST="example.com"
        )
        self.assertRedirect(
            "./test.html", "http://example.com:81/test.html", HTTP_HOST="example.com:81"
        )
        # Trust HTTP_HOST over SERVER_NAME and PORT.
        self.assertRedirect(
            "./test.html",
            "http://example.com:81/test.html",
